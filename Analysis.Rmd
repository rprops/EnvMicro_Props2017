...
div.FCM <- read.csv2("Lakes_diversityFCM_F.csv")
div.16S <- read.csv2("Lakes_diversity16S_F.csv")
...
div.ref <- read.csv2("REF_diversity.csv")
...
# Chlorophyl data
Chl <- read.csv("Lakes_metadata_Chl.csv")
...
meta.mus <- read.csv2("Experiment_metadata_mussels.csv")
